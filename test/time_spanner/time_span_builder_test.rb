  ...
  class TimeSpanBuilderTest < TestCase
    ...
    describe 'millenniums' do
      ...
      it 'should calculate 2 millenniums' do
        ...
        assert_equal 2, time_span_builder.time_span[:millenniums]
        assert_all_zero_except(time_span_builder, :millenniums)
      end
    ...
    describe 'centuries' do
      ...
      it 'should calculate 1 century' do
        ...
        assert_equal 1, time_span_builder.time_span[:centuries]
        assert_all_zero_except(time_span_builder, :centuries)
      end
      ...
      it 'should calculate 2 centuries' do
        ...
        assert_equal 2, time_span_builder.time_span[:centuries]
        assert_all_zero_except(time_span_builder, :centuries)
      end
    ...
    describe 'decades' do
      ...
      it 'should calculate 1 decade' do
        ...
        assert_equal 1, time_span_builder.time_span[:decades]
        assert_all_zero_except(time_span_builder, :decades)
      end
      ...
      it 'should calculate 2 decades' do
        ...
        assert_equal 2, time_span_builder.time_span[:decades]
        assert_all_zero_except(time_span_builder, :decades)
      end
    ...
    describe 'years' do
      ...
      it 'should calculate 1 year' do
        ...
        assert_equal 1, time_span_builder.time_span[:years]
        assert_all_zero_except(time_span_builder, :years)
      end
      ...
      it 'should calculate 2 years' do
        ...
        assert_equal 2, time_span_builder.time_span[:years]
        assert_all_zero_except(time_span_builder, :years)
      end

      #TODO: remove when DurationHelper.time_span[:years]() does the calculation
      describe 'leaps' do
    ...
    describe 'weeks' do
      ...
      it 'should calculate 1 week' do
        ...
        assert_equal 1, time_span_builder.time_span[:weeks]
        assert_all_zero_except(time_span_builder, :weeks)
      end
      ...
      it 'should calculate 2 weeks' do
        ...
        assert_equal 2, time_span_builder.time_span[:weeks]
        assert_all_zero_except(time_span_builder, :weeks)
      end
    ...
    describe 'days' do
      ...
      it 'should calculate 1 day' do
        ...
        assert_equal 1, time_span_builder.time_span[:days]
        assert_all_zero_except(time_span_builder, :days)
      end
    ...
    describe 'hours' do
      ...
      it 'should calculate 1 hour' do
        ...
        assert_equal 1, time_span_builder.time_span[:hours]
        assert_all_zero_except(time_span_builder, :hours)
      end
      ...
      it 'should calculate 2 hours' do
        ...
        assert_equal 2, time_span_builder.time_span[:hours]
        assert_all_zero_except(time_span_builder, :hours)
      end
    ...
    describe 'seconds' do
      ...
      it 'should calculate 1 seconds' do
        ...
        assert_equal 1, time_span_builder.time_span[:seconds]
        assert_all_zero_except(time_span_builder, :seconds)
      end
      ...
      it 'should calculate 2 seconds' do
        ...
        assert_equal 2, time_span_builder.time_span[:seconds]
        assert_all_zero_except(time_span_builder, :seconds)
      end
    ...
    describe 'milliseconds' do
      ...
      it 'should calculate 1 millisecond' do
        ...
        assert_equal 1, time_span_builder.time_span[:millis]
        assert_all_zero_except(time_span_builder, :millis)
      end
      ...
      it 'should calculate 2 milliseconds' do
        ...
        assert_equal 2, time_span_builder.time_span[:millis]
        assert_all_zero_except(time_span_builder, :millis)
      end
      ...
      it 'should calculate 4 milliseconds' do
        ...
        assert_equal 517, time_span_builder.time_span[:millis]
        assert_all_zero_except(time_span_builder, :millis)
      end
    ...
    describe 'microseconds' do
      ...
      it 'should calculate 1 microsecond' do
        ...
        assert_equal 1, time_span_builder.time_span[:micros]
        assert_all_zero_except(time_span_builder, :micros)
      end
      ...
      it 'should calculate 235 microseconds' do
        ...
        assert_equal 235, time_span_builder.time_span[:micros]
        assert_all_zero_except(time_span_builder, :micros)
      end
    ...
    describe 'nanoseconds' do
      ...
      it 'should calculate 1 nanosecond' do
        ...
        assert_equal 1, time_span_builder.time_span[:nanos]
        assert_all_zero_except(time_span_builder, :nanos)
      end
      ...
      it 'should calculate 235 nanoseconds' do
        ...
        assert_equal 235, time_span_builder.time_span[:nanos]
        assert_all_zero_except(time_span_builder, :nanos)
      end
