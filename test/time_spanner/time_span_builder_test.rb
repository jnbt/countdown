  ...
  class TimeSpanBuilderTest < TestCase
    ...
    describe 'output all time units' do
      ...
      it 'should output days (in the future)' do
        ...
        expected = {millenniums: 0, centuries: 0, decades: 0, years: 0, months: 0, weeks: 0, days: 3, hours: 0, minutes: 0, seconds: 0, milliseconds: 0, microseconds: 0, nanoseconds: 0}
        assert_equal expected.sort, time_span_builder.time_span.sort
      end
      ...
      it 'should output days and weeks (in the future)' do
        ...
        expected = {millenniums: 0, centuries: 0, decades: 0, years: 0, months: 0, weeks: 1, days: 3, hours: 0, minutes: 0, seconds: 0, milliseconds: 0, microseconds: 0, nanoseconds: 0}
        assert_equal expected.sort, time_span_builder.time_span.sort
      end
      ...
      it 'should output days/weeks/months (in the future)' do
        ...
        expected = {millenniums: 0, centuries: 0, decades: 0, years: 0, months: 2, weeks: 1, days: 3, hours: 0, minutes: 0, seconds: 0, milliseconds: 0, microseconds: 0, nanoseconds: 0}
        assert_equal expected.sort, time_span_builder.time_span.sort
      end
    ...
    describe 'output only 1 unit' do
      ...
      it 'should output only nanoseconds' do
        starting_time = Time.at @now.to_time.to_f
        target_time   = Time.at(starting_time.to_f, 0.235)
        time_span_builder = TimeSpanBuilder.new(starting_time, target_time, [:nanoseconds])

        expected = {nanoseconds: 235}
        assert_equal expected.sort, time_span_builder.time_span.sort
      end
    ...
    describe 'unit switches' do
      ...
      it 'switches everything' do
        ...
        Timecop.travel(Time.at(starting_time.to_f, 0.001)) do
          ...
          assert_equal 999, time_span_builder.time_span[:milliseconds]
          assert_equal 999, time_span_builder.time_span[:microseconds]
          assert_equal 999, time_span_builder.time_span[:nanoseconds]
        end
      end
      ...
      it 'switches from seconds to milliseconds' do
        starting_time = DateTime.parse('2013-01-01 22:01:00').to_time
      ...
      it 'switches from milliseconds to microseconds' do
        ...
        assert_equal 1, time_span_builder.time_span[:milliseconds]
        assert_equal 0, time_span_builder.time_span[:microseconds]
      ...
      it 'switches from micro- to nanoseconds' do
        ...
        assert_equal 1, time_span_builder.time_span[:microseconds]
        assert_equal 0, time_span_builder.time_span[:nanoseconds]
    ...
    describe 'edge cases' do
      ...
      describe 'unix epoch' do
        ...
        it 'should calculate dates before 1970' do
          ...
          expected = {millenniums: 0, centuries: 0, decades: 5, years: 0, months: 0, weeks: 0, days: 0, hours: 0, minutes: 0, seconds: 0, milliseconds: 0, microseconds: 0, nanoseconds: 0}
          assert_equal expected.sort, time_span_builder.time_span.sort
        end
        ...
        it 'should calculate dates after 2039' do
          ...
          expected = {millenniums: 0, centuries: 0, decades: 9, years: 0, months: 0, weeks: 0, days: 0, hours: 0, minutes: 0, seconds: 0, milliseconds: 0, microseconds: 0, nanoseconds: 0}
          assert_equal expected.sort, time_span_builder.time_span.sort
        end
    ...
    def assert_all_zero_except(time_span_builder, *time_units)
      units = [:millenniums, :decades, :decades, :years, :months, :weeks, :days, :hours, :minutes, :seconds, :milliseconds, :microseconds, :nanoseconds] - time_units
      not_zero = []
