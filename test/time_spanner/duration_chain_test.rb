  ...
  class DurationChainTest < TestCase
    ...
    describe 'calculation by given units' do
      ...
      it 'initializes' do
        ...
        assert_equal [], chain.spanned_units
      end

      it 'sorts' do
        chain  = DurationChain.new(@from, @to, [Second, Hour, Minute])

        assert chain.spanned_units.first.is_a?(Hour)
        assert chain.spanned_units[1].is_a?(Minute)
        assert chain.spanned_units.last.is_a?(Second)
      end
      ...
      it 'calculates decades and succeeding units (ensures leap years are correctly calculated)' do
        ...
        assert_equal 1, chain.spanned_units[0].amount
        assert_equal 0, chain.spanned_units[1].amount
        assert_equal 0, chain.spanned_units[2].amount
        assert_equal 0, chain.spanned_units[3].amount
        assert_equal 0, chain.spanned_units[4].amount
        assert_equal 0, chain.spanned_units[5].amount
        assert_equal 0, chain.spanned_units[6].amount
        assert_equal 0, chain.spanned_units[7].amount
        assert_equal 0, chain.spanned_units[8].amount
        assert_equal 0, chain.spanned_units[9].amount
        assert_equal 0, chain.spanned_units[10].amount
      end
      ...
      describe 'one unit given' do
        ...
        it 'calculates hours' do
          ...
          assert_equal 2, chain.spanned_units.first.amount
        end

        it 'calculates minutes' do
          chain = DurationChain.new(@from, @to, [Minute])

          assert_equal 132, chain.spanned_units.first.amount
        end

        it 'calculates seconds' do
          chain = DurationChain.new(@from, @to, [Second])

          assert_equal 7957, chain.spanned_units.first.amount
        end
      ...
      describe 'two units given' do
        ...
        it 'calculates hours and minutes' do
          ...
          assert_equal 2, chain.spanned_units.first.amount
          assert_equal 12, chain.spanned_units.last.amount
        end
        ...
        it 'calculates minutes and seconds' do
          ...
          assert_equal 132, chain.spanned_units.first.amount
          assert_equal 37, chain.spanned_units.last.amount
        end
        ...
        it 'calculates hours and seconds' do
          ...
          assert_equal 2, chain.spanned_units.first.amount
          assert_equal 757, chain.spanned_units.last.amount
        end
        ...
        it 'calculates months and days' do
          ...
          assert_equal 3, chain.spanned_units.first.amount
          assert_equal 18, chain.spanned_units.last.amount
        end
        ...
        it 'calculates months with microseconds' do
          ...
          assert_equal 4, chain.spanned_units.first.amount
          assert_equal 2, chain.spanned_units.last.amount
        end
        ...
        it 'calculates years and months' do
          ...
          assert_equal 3, chain.spanned_units.first.amount
          assert_equal 4, chain.spanned_units.last.amount
        end
        ...
        it 'calculates decades and years' do
          ...
          assert_equal 2, chain.spanned_units.first.amount
          assert_equal 3, chain.spanned_units.last.amount
        end
        ...
        it 'calculates milleniums and nanoseconds' do
          ...
          assert_equal 2, chain.spanned_units.first.amount
          assert_equal 1, chain.spanned_units.last.amount
        end
      ...
      describe 'three units given' do
        ...
        it 'calculates hours, minutes and seconds' do
          ...
          assert_equal 2, chain.spanned_units.first.amount
          assert_equal 12, chain.spanned_units[1].amount
          assert_equal 37, chain.spanned_units.last.amount
        end
        ...
        it 'calculates months, days and hours' do
          ...
          assert_equal 3, chain.spanned_units.first.amount
          assert_equal 18, chain.spanned_units[1].amount
          assert_equal 2, chain.spanned_units.last.amount
        end
        ...
        it 'calculates months, weeks and days' do
          ...
          assert_equal 3, chain.spanned_units.first.amount
          assert_equal 2, chain.spanned_units[1].amount
          assert_equal 4, chain.spanned_units.last.amount
        end
      ...
      describe 'all units given' do
        ...
        it 'calculates everything' do
          ...
          assert_equal 3,   chain.spanned_units[0].amount
          assert_equal 4,   chain.spanned_units[1].amount
          assert_equal 3,   chain.spanned_units[2].amount
          assert_equal 4,   chain.spanned_units[3].amount
          assert_equal 5,   chain.spanned_units[4].amount
          assert_equal 3,   chain.spanned_units[5].amount
          assert_equal 4,   chain.spanned_units[6].amount
          assert_equal 10,  chain.spanned_units[7].amount
          assert_equal 36,  chain.spanned_units[8].amount
          assert_equal 16,  chain.spanned_units[9].amount
          assert_equal 937, chain.spanned_units[10].amount
          assert_equal 242, chain.spanned_units[11].amount
          assert_equal 354, chain.spanned_units[12].amount
        end
        ...
        it 'calculates only some of them' do
          ...
          assert_equal 0,  chain.spanned_units[0].amount
          assert_equal 0,  chain.spanned_units[1].amount
          assert_equal 0,  chain.spanned_units[2].amount
          assert_equal 1,  chain.spanned_units[3].amount
          assert_equal 0,  chain.spanned_units[4].amount
          assert_equal 0,  chain.spanned_units[5].amount
          assert_equal 4,  chain.spanned_units[6].amount
          assert_equal 0,  chain.spanned_units[7].amount
          assert_equal 0,  chain.spanned_units[8].amount
          assert_equal 58, chain.spanned_units[9].amount
          assert_equal 0,  chain.spanned_units[10].amount
          assert_equal 0,  chain.spanned_units[11].amount
          assert_equal 2,  chain.spanned_units[12].amount
        end
        ...
        it 'calculates nothing' do
          ...
          assert_equal 0, chain.spanned_units[10].amount
          assert_equal 0, chain.spanned_units[11].amount
          assert_equal 0, chain.spanned_units[12].amount
        end
