...
module TimeSpanner
  module TimeUnits
    ...
    class TimeUnitCollectionTest < TestCase
      ...
      it 'initializes' do
        collection = TimeUnitCollection.new(DateTime.now, DateTime.now+1, 3453453, [:hours])
      ...
      it 'calculates 1 unit' do
        ...
        duration   = TimeHelpers::TimeSpan.new(starting_time, target_time).total_nanoseconds
        collection = TimeUnitCollection.new(starting_time, target_time, duration, [:hours])
      ...
      it 'calculates 2 units in a row' do
        ...
        duration   = TimeHelpers::TimeSpan.new(starting_time, target_time).total_nanoseconds
        collection = TimeUnitCollection.new(starting_time, target_time, duration, [:hours, :minutes])
      ...
      it 'should sort' do
        collection  = TimeUnitCollection.new(DateTime.now, DateTime.now+1, 345346435657567567, [:minutes, :hours])
