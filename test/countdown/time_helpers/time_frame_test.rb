  ...
  class TimeframeTest < TestCase
    ...
    describe 'nanos' do
      ...
      it 'should calculate duration for 1 day in the future' do
        assert_equal 86400000000000, Timeframe.new(@now, @now+1).nanos
      end
      ...
      it 'should calculate duration for same timestamp' do
        assert_equal 0, Timeframe.new(@now, @now).nanos
      end

      it 'should calculate duration for last week' do
        assert_equal 86400000000000, Timeframe.new(@now-7, @now-6).nanos
      end
    ...
    describe 'days' do
      ...
      it 'sums up days by upcoming months' do
        ...
        assert_equal 167, Timeframe.days_in_timeframe(from, to)
      end
    ...
    describe 'months and days' do
      ...
      it 'converts days to months and days by remaining_days given 0 days' do
        ...
        remaining_days = 0
        months_days    = Timeframe.months_and_days(target_time, remaining_days)
